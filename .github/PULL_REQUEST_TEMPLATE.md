...
<!-- atomic-superpowers core contains general-purpose skills and infrastructure
...
| Claude Code version | Model | Model version/ID | OS |
|---------------------|-------|------------------|-----|
|                     |       |                  |    |
...
- [ ] If this is a skills change: I used `atomic-superpowers:writing-skills` and
