...
**The terminal state is invoking writing-plans.** Do NOT invoke frontend-design, mcp-builder, or any other implementation skill. The ONLY skill you invoke after the spec is approved is writing-plans.
...
- After the user approves the spec, invoke the writing-plans skill to create the implementation plan.
