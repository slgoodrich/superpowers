...
output=$(run_claude "What is the atomic-issues skill? Describe what makes an issue atomic." 60)
...
output=$(run_claude "In atomic-issues, what is the 'and' test? When does 'and' indicate two issues vs one?" 60)
...
output=$(run_claude "When does brainstorming invoke the atomic-issues skill?" 60)
