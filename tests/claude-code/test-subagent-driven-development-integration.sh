...
# IMPORTANT: Run from atomic-superpowers directory so local dev skills are available
...
if grep -q '"name":"Skill".*"skill":"atomic-superpowers:subagent-driven-development"' "$SESSION_FILE"; then
