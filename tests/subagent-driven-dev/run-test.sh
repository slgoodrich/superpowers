...
#   ./run-test.sh svelte-todo --plugin-dir /path/to/superpowers-plus
...
TIMESTAMP=$(date +%s)
OUTPUT_BASE="/tmp/superpowers-plus-tests/$TIMESTAMP/subagent-driven-development"
...
PROMPT="Execute this plan using superpowers-plus:subagent-driven-development. The plan is at: $PLAN_PATH"
